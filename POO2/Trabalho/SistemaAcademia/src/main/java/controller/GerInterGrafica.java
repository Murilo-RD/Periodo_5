...
public class GerInterGrafica {
    ...
    public void abrirJanelaAlterar(Usuario usuario){
        if(janelaAlterar == null )
            janelaAlterar = new AlterarJD(janelaPrincipal,true,this, usuario);
        else{
            janelaAlterar.setUsuario(usuario);    
        }
