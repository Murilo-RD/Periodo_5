...
import controller.TableModelProduto;
...
public class ProdutoMain extends javax.swing.JFrame {
    ...
    TableModelProduto tbModel;
    /**
     * Creates new form ProdutoMain
     */
    public ProdutoMain(GerInterGrafica gerIG) {
        initComponents();
        this.gerIG = gerIG;
        gerIG.carregarCombo(cmbCategoria);
        tbModel = new TableModelProduto();
        jTable3.setModel(tbModel);
    }
    ...
    public void inserirProduto(){
        ...
        int id = gerIG.inserirProduto(nome, qtde, preco, (Categoria) cmbCategoria.getSelectedItem());
    ...
    private void btnListarTodosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarTodosActionPerformed
        try {
            List<Produto>  list = gerIG.getGerDominio().listarProdutos();
            tbModel.setList(list);
            jTable3.updateUI();       // TODO add your handling code here:
        } catch (ClassNotFoundException ex) {
            JOptionPane.showMessageDialog(this,"Erro ao listar: "+ex);
    ...
    private void btnInsProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsProdutoActionPerformed
        inserirProduto();        // TODO add your handling code here:
    ...
    private void btnInsCategoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsCategoriaActionPerformed
        gerIG.inserirCategoria(txtNomeCategoria.getText());
        gerIG.carregarCombo(cmbCategoria);
    }//GEN-LAST:event_btnInsCategoriaActionPerformed

    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        try {
            Produto prod = gerIG.getGerDominio().PesquisarProdutos(Integer.parseInt(txtIdProduto.getText())); 
            txtNomeProduto.setText(prod.getNom());
            txtQtde.setText(""+prod.getQuntidade());
            txtPreco.setText(""+prod.getPreco());
            cmbCategoria.setSelectedIndex(prod.getCat().getIdCategoria()-1);
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        double preco = Double.parseDouble(txtPreco.getText()); 
        gerIG.alterarProduto(id, nome, qtde, preco, (Categoria) cmbCategoria.getSelectedItem());
    ...
    private void btnListarEstoqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarEstoqueActionPerformed
        try {
            int estoque = Integer.parseInt(txtQtde.getText());
            List<Produto>  list = gerIG.getGerDominio().listarProdutos(estoque);
            tbModel.setList(list);
            jTable3.updateUI();
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ProdutoMain.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(ProdutoMain.class.getName()).log(Level.SEVERE, null, ex);
        }
